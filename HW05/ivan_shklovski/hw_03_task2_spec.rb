...
describe 'task_2' do
  ...
  context 'return formatted lines without errors' do
    it 'should return formatted strings without error when we call the task_2 method' do
      expect(task_2(logs)).to eq strings_without_errors.split("\n")
    end
  end

  context 'if logs have no suitable strings' do
    it 'should return empty array when we call the task_2 method' do
      expect(task_2(logs_without_suitable_strings)).to eq []
    end
  end

  context 'if logs have strings with wrong format' do
    it 'should return empty array when we call the task_2 method' do
